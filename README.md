...
[![NuGet](https://img.shields.io/badge/NuGet-v1.2.1-blue.svg)](https://www.nuget.org/packages/Gof.DesignPatterns/)

You can install the latest stable version of **Gof.DesignPatterns** using NuGet:

```bash
PM> Install-Package Gof.DesignPatterns -Version 1.2.1
```
